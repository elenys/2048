...
ft_strcat.c ft_strchr.c ft_strcmp.c ft_strcpy.c ft_strdup.c ft_strlcat.c \
ft_strncat.c ft_strncmp.c ft_strncpy.c ft_strnstr.c ft_strstr.c ft_tolower.c \
ft_toupper.c ft_strlen.c ft_strrchr.c ft_memset.c ft_itoa.c ft_memalloc.c \
